#include "bank.utxo.hpp"

[[eosio::action]]
void bankutxo::create(name issuer, asset maximum_supply) {
    require_auth( _self );
...
[[eosio::action]]
void bankutxo::issue(public_key to, asset quantity, const string memo) {
...
void bankutxo::sub_balance(public_key sender, asset value) {
...
void bankutxo::add_balance(public_key recipient, asset value) {
...
EOSIO_DISPATCH(bankutxo, (create)(issue)(transfer))
